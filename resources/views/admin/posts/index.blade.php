...
@section('content')
  <div class="container">
    ...
    @endcomponent
    <hr>
<a href="{{route('admin.post.create')}}" class="btn btn-primary"><i class="fas fa-plus-square-o"></i> Створити товар</a>
<table class="table table-striped">
    ...
    <td width='50%'>{{$post->title}}</td>
        ...
        <td class="text-right">
            ...
            @csrf
            <a href="{{route('admin.post.edit', $post)}}" class="btn btn-primary"><i class="fas fa-plus-square-o"></i> Редагувати товар</a>
