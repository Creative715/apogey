...
@section('content')
  <div class="container">
    ...
    @endcomponent
    <hr>
<a href="{{route('admin.page.create')}}" class="btn btn-primary"><i class="fas fa-plus-square-o"></i> Створити сторінку</a>
<table class="table table-striped">
    ...
    <td width='50%'>{{$page->title}}</td>
        ...
        <td class="text-right">
            ...
            @csrf
            <a href="{{route('admin.page.edit', $page)}}" class="btn btn-primary"><i class="fas fa-plus-square-o"></i> Редагувати сторінку</a>
