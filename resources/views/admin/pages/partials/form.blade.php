...
<input class="form-control" type="text" name="slug" placeholder="Генерується автоматично" value="{{ $page->slug ?? ''}}" readonly="">
<div class="form-group">
<label for="">Короткий опис</label>
<textarea class="form-control" id="intro" name="intro" cols="30" rows="4">{{ old('intro') ?? $page->intro ?? ''}}</textarea>
</div>
<div class="form-group">
  <input type="file" name="img" value="{{ old('img') ?? $page->img ?? ''}}">
</div>
<div class="form-group">
