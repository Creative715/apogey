                    ...
                    <div class="rd-navbar-inner-outer">
                      <div class="rd-navbar-inner">
                        ...
                        <div class="rd-navbar-panel">
                          ...
                          <!-- RD Navbar Brand-->
                          <div class="rd-navbar-brand"><a class="brand" href="{{ route('en') }}"><img class="brand-logo-dark" src="/images/logo-en.jpg" alt="" width="198" height="66"/></a></div>
                        </div>
                            ...
                            <ul class="rd-navbar-contacts-2">
                              ...
                              <li>
                                <div class="unit unit-spacing-xs">
                                  ...
                                  <div class="unit-body"><a class="address" href="#">Apogey ltd, 02094, Ukaine, Kyiv, Jury Popravka str. 6</a></div>
                                </div>
                              </li>
                            </ul>
                            <ul class="list-inline">
                              <div class="dropdown">
                              <a style="font-size: 18px;color: #000;" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">| EN |</a>
                        ...
                        <div class="rd-navbar-project">
                          <div class="rd-navbar-project-header">
                            <h5 class="rd-navbar-project-title">Follow US</h5>
                            ...
                            <div class="container">
                              <div class="row row-50">
                                <div class="col-md-7 col-lg-7 col-xl-7" style="padding-left:55px;">
                                  <h5 class="footer-modern-title oh-desktop"><span class="d-inline-block wow slideInLeft">Office</span></h5>
                                ...
                                <div class="col-lg-5 col-xl-5">
                                  <h5 class="footer-modern-title oh-desktop"><span class="d-inline-block wow slideInLeft">Manufacturing facility</span></h5>
